...
class SecureFilesType extends AbstractType
{
    /**
    ...
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        ...
        ->add('filename', TextType::class, [
                'label' => $this->translator->trans('FileName'),
                'required' => false,
                'attr' => [
                    'placeholder' => $this->translator->trans('Enter the name of the file'),
                    'maxlength' => 255,
                ],
            'constraints' => [
                new NotBlank([
                    'message' => $this->translator->trans('The file name is required.'),
                ]),
            ],
            ])
