 ...
 */
final class Version20250727111155 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE logs (id INT AUTO_INCREMENT NOT NULL, note_id INT NOT NULL, user_id INT NOT NULL, deleted_at DATETIME NOT NULL, ip_adress VARCHAR(255) NOT NULL, user_agent VARCHAR(255) DEFAULT NULL, additionnal_data LONGTEXT DEFAULT NULL, slug VARCHAR(255) NOT NULL, INDEX IDX_F08FC65C26ED0855 (note_id), INDEX IDX_F08FC65CA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
